<?
// Klassendefinition
class Do16ToWord extends IPSModule {
    ...
    public function Create() {
        ...
        $this->RegisterVariableBoolean("Q09", "Ausgang 9","",90);
        $this->EnableAction("Q09");
        $this->RegisterVariableBoolean("Q10", "Ausgang 10","",100);
        $this->EnableAction("Q10");
        $this->RegisterVariableBoolean("Q11", "Ausgang 11","",110);
        $this->EnableAction("Q11");
        $this->RegisterVariableBoolean("Q12", "Ausgang 12","",120);
        $this->EnableAction("Q12");
        $this->RegisterVariableBoolean("Q13", "Ausgang 13","",130);
        $this->EnableAction("Q13");
        $this->RegisterVariableBoolean("Q14", "Ausgang 14","",140);
        $this->EnableAction("Q14");
        $this->RegisterVariableBoolean("Q15", "Ausgang 15","",150);
        $this->EnableAction("Q15");
        $this->RegisterVariableBoolean("Q16", "Ausgang 16","",160);
        $this->EnableAction("Q16");
    ...
    public function checkValues(){
        ...
        $IdQ09 = $this->GetIDForIdent("Q09");
        $IdQ10 = $this->GetIDForIdent("Q10");
        $IdQ11 = $this->GetIDForIdent("Q11");
        $IdQ12 = $this->GetIDForIdent("Q12");
        $IdQ13 = $this->GetIDForIdent("Q13");
        $IdQ14 = $this->GetIDForIdent("Q14");
        $IdQ15 = $this->GetIDForIdent("Q15");
        $IdQ16 = $this->GetIDForIdent("Q16");
        ...
        $outputs[8]  = $this->GetValueBooleanNull($IdQ09);
        $outputs[9]  = $this->GetValueBooleanNull($IdQ10);
        $outputs[10] = $this->GetValueBooleanNull($IdQ11);
        $outputs[11] = $this->GetValueBooleanNull($IdQ12);
        $outputs[12] = $this->GetValueBooleanNull($IdQ13);
        $outputs[13] = $this->GetValueBooleanNull($IdQ14);
        $outputs[14] = $this->GetValueBooleanNull($IdQ15);
        $outputs[15] = $this->GetValueBooleanNull($IdQ16);
